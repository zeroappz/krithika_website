...
<head>
	...
	<!--=== Favicon ===-->
	<link rel="icon" type="image/png" href="assets/images/krithika.png" style="width:80px; height:20px !important;">
	<!--=== Title ===-->
			...
			<div class="row justify-content-center">
					...
					<div class="main-doctors-item hover-style wow fadeInUp delay-0-2s">
						<div class="inner-border">
							<div class="doctor-img">
								<img src="assets/images/doctors/rajkumar_2.jpeg" alt="Image" style="width:329px; height:293px;">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="main-doctors-item hover-style wow fadeInUp delay-0-4s">
						<div class="inner-border">
							<div class="doctor-img">
								<img src="assets/images/doctors/kamaraj.png" alt="Image" style="width:329px; height:293px;">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="main-doctors-item hover-style wow fadeInUp delay-0-6s">
						<div class="inner-border">
							<div class="doctor-img">
								<img src="assets/images/doctors/doctor-3.jpg" alt="Image" style="width:329px; height:293px;">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="main-doctors-item hover-style wow fadeInUp delay-0-2s">
						<div class="inner-border">
							<div class="doctor-img">
								<img src="assets/images/doctors/doctor-4.jpg" alt="Image" style="width:329px; height:293px;">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="main-doctors-item hover-style wow fadeInUp delay-0-4s">
						<div class="inner-border">
							<div class="doctor-img">
								<img src="assets/images/doctors/vasanthan_1.jpeg" alt="Image" style="width:329px; height:293px;">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="main-doctors-item hover-style wow fadeInUp delay-0-6s">
						<div class="inner-border">
							<div class="doctor-img">
								<img src="assets/images/doctors/arunselva.png" alt="Image" style="width:329px; height:293px;">
				...
				<div class="col-lg-12">
					<div class="pagination">
						...
						<a href="doctorslist.php" class="page-count current hover-style" aria-current="page">
							<div class="inner-border">1</div>
						</a>
						<a href="doctorslist1.php" class="page-count hover-style">
