...
<!--=== Start About Us Section ===-->
	<section class="about-us-section pb-100 container" id="about_us">
	...
	<!--=== End About Us Section ===-->
		...
		<!-- <section class="container mt-5">
			<div class="row">
				<div class="col-md-6">
					...
					<h3 class="text-center  wow fadeInUp delay-0-2s">Our Treatment Room</h3>
					<div class="about-img wow fadeInUp delay-0-2s">
					<img src="assets/images/clinic-area2.jpeg" class="my-3 rounded about_card" style="    height: 290px;" alt="Image">
					</div>
					<p  class="wow fadeInUp delay-0-2s">Treatment rooms are valuable spaces in medical facilities where patients receive specialized care and procedures. These rooms are equipped with advanced medical tools and technology, providing a safe and controlled environment for efficient treatments, examinations, and minor surgical procedures. They are essential for patients as they ensure focused attention from healthcare professionals and promote faster recovery while maintaining privacy and comfort.</p>
					</div>
				</div> -->
				...
				<!-- <div class="col-md-6">
					...
					<p class="wow fadeInUp delay-0-2s">Additionally, the waiting area should be well-lit and have adequate ventilation to promote a pleasant and inviting atmosphere. Staff members are usually available in the area to address any inquiries or concerns that patients may have.</p>
		...
		<section class="container mt-5">
			<!-- <h2 class="text-center  wow fadeInUp delay-0-2s my-5">Lab Equipments</h2> -->
			<div class="row">
				<div class="about-content ms-15">
		...
		<section class="container mt-5">
			...
			<div class="col-md-6">
				...
				<!-- <div class="col-md-6">
					...
					<p class="wow fadeInUp delay-0-2s"><b>Accuracy:</b> Intraoral scanners can provide highly accurate digital impressions of a patient's teeth and oral tissues, leading to more precise treatment planning and better-fitting restorations.<br></p>
		...
		<!-- <section class="our-quality-area pb-70">
			<div class="container">
				<div class="main-section-title wow fadeInUp delay-0-2s">
					...
					<h2>We Do Our Best To Maintain The Quality Of Our Services.</h2>
				</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="main-quality-item hover-style">
							<div class="inner-border">
								...
								<h3>Healthcare</h3>
								<p>Achieving healthy teeth takes a lifetime of care. Even if you’ve been told that you have nice.</p>
							</div>
						</div>
					</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-6 pe-0">
						<div class="appointment-img ms-15 wow fadeInUp delay-0-4s">
							<img src="assets/images/appointment-img.png" alt="Image">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 col-md-7">
						<p>Copyright © <span>Kirthika Dental Care</span> All RIghts Reserved <a href="https://www.macincode.com" target="_blank">Macincode</a></p>
					</div>
