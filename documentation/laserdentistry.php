			...
			<div class="container">
				<div class="page-banner-content">
					...
					<ul>
						...
						<li>
							<span class="active">Laser Dentistry</span>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="services-details-content ms-15">
							...
							<ul>
								<!-- <li> -->
									<p><b>Does laser dentistry help in curing gum diseases?</b><br></p>
									<!-- <span>1</span> -->
									Yes, laser dentistry helps to treat gum diseases by first targeting and then vaporizing the gum tissues.Laser dentistry
...
<<<<<<< HEAD:documentation/laserdentistry.php
...
>>>>>>> 464065ab7904192b45306214cb054b634ddf38e7:laserdentistry.php
					</div>
