			...
			<div class="container">
				<div class="page-banner-content">
					...
					<ul>
						...
						<li>
							<span class="active">Dentures</span>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="col-lg-8">
						<div class="services-details-content ms-15">
							<div class="services-img-1">
								<img src="assets/images/services/dentures-section-1.png" alt="Image">
							</div>
							<h4>Introduction</h4>
							<h3>Dentures</h3>
							...
							<h4>What is the life of dentures?</h4>
...
<<<<<<< HEAD:documentation/dentures.php
...
>>>>>>> 464065ab7904192b45306214cb054b634ddf38e7:dentures.php
					</div>
