			...
			<div class="container">
				<div class="page-banner-content">
					...
					<ul>
						...
						<li>
							<span class="active">Smile Makeover</span>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="col-lg-8">
						<div class="services-details-content ms-15">
							<div class="services-img-1">
								<img src="assets\images\services\smile-makeover-section-1.png" alt="Image">
							</div>
							<h4>Introduction</h4>
							...
							<h4>What factors should be kept in mind to get natural results??</h4>
							<p>Factors such as gender, age, lifestyle, structure of the face should be taken care of by the dentist before going for a smile makeover.</p>
...
<p>
                            ...
                            <p><b>Is the smile makeover covered under insurance?</b></p>
                            <p>Smile makeover is normally not covered under insurance as it is a cosmetic treatment and is done to improve one’s appearance.</p>
							<!-- <ul>
								<li>
									<p><b>Why teeth become irregular?</b><br></p>
									<span>1</span>
...
<<<<<<< HEAD:documentation/smilemakeover.php
...
>>>>>>> 464065ab7904192b45306214cb054b634ddf38e7:smilemakeover.php
					</div>
