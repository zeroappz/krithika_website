...
<body>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="main-contact-info-item hover-style wow fadeInUp delay-0-6s">
						<div class="inner-border">
							...
							<ul>
								<li>
									<a href="tel:+7-(903)-679-96-15">0427 3572417</a><br>
									<a href="tel:+7-(800)-633-88-77">+91 8006338877</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div class="contact-us-form pb-100">
		<div class="container">
			<div class="row" style="border-radius: 5px; box-shadow:5px black">
				<!-- <div class="col-lg-3"> -->
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-floating form-group">
										...
										<label for="yourSubject" class="form-label">Reason to Meet</label>
