		...
		<section class="page-banner-section bg-color-ebeef5 ptb-100">
			<div class="container">
				<div class="page-banner-content">
					<h2>Restorativedentistry</h2>
					<ul>
						<li>
							<a href="index.php">Home</a>
						</li>
						<li>
							<span class="active">Restorativedentistry</span>
						</li>
					</ul>
				</div>
			</div>
...
<<<<<<< HEAD:documentation/restorativedentistry.php
...
>>>>>>> 464065ab7904192b45306214cb054b634ddf38e7:restorativedentistry.php
					</div>
