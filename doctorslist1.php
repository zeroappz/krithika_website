            ...
            <div class="row justify-content-center">
                    ...
                    <div class="main-doctors-item hover-style wow fadeInUp delay-0-2s">
                        <div class="inner-border">
                            <div class="doctor-img">
                                <img src="assets/images/doctors/ayyadurai_1.jpeg" alt="Image" style="width:329px; height:293px;">
                ...
                <!-- <div class="col-lg-4 col-sm-6">
                    <div class="main-doctors-item hover-style wow fadeInUp delay-0-4s">
                        <div class="inner-border">
                            <div class="doctor-img">
                                <img src="assets/images/doctors/doctor-6.jpg" alt="Image" style="width:329px; height:293px;">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="main-doctors-item hover-style wow fadeInUp delay-0-4s">
                        <div class="inner-border">
                            <div class="doctor-img">
                                <img src="assets/images/doctors/doctor-1.jpg" alt="Image" style="width:329px; height:293px;">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="main-doctors-item hover-style wow fadeInUp delay-0-6s">
                        <div class="inner-border">
                            <div class="doctor-img">
                                <img src="assets/images/doctors/doctor-2.jpg" alt="Image" style="width:329px; height:293px;">
                ...
                <div class="col-lg-12">
                    <div class="pagination">
                        ...
                        <a href="doctorslist.php" class="page-count  hover-style" aria-current="page">
                            <div class="inner-border">1</div>
                        </a>
                        <a href="doctorslist1.php" class="page-count current hover-style">
