			...
			<div class="row">
				<div class="col-lg-6">
					<div class="banner-content pt-100">
						<h1 class="wow fadeInUp delay-0-2s">WELCOME TO KRITHIKA DENTAL CARE</h1>
						<p class="wow fadeInUp delay-0-4s">We are committed to providing our patients best-in-class
